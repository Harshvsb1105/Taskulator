    ...
    return Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(description, style: TextStyle(color: Color(0xffa2bfbd)),),
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        FlatButton(
                          child: Text(
                              pageIndex == 0 ? "Cancel"
                                  : "Back", style: TextStyle(color: Color(0xffa2bfbd)),),
                          onPressed: () {
                            if (pageIndex == 0)
                              Navigator.pop(context);
                            else
                        ...
                        Consumer<Suggestions>(
                          builder: (_, suggestionsState, __) => RaisedButton(
                            child: Text(pageIndex == 2 ? 'Submit' : 'Next',style: TextStyle(color: Color(0xff425c5a))),
                            onPressed: () {
    ...
    _pages = [
      buildPage(
        ...
        textField: TextFormField(
          // textFieldConfiguration: TextFieldConfiguration(
            ...
            autofocus: true,
            decoration: InputDecoration(prefixIcon: Icon(Icons.person,color: Color(0xffffcea2),)),
      ...
      buildPage(
        ...
        textField: TextFormField(
          ...
          decoration: InputDecoration(prefixIcon: Icon(Icons.card_giftcard, color: Color(0xffffcea2),)),
          validator: (value) {
      ...
      buildPage(
        ...
        textField: TextFormField(
          ...
          decoration: InputDecoration(
            prefixIcon: Icon(Icons.message,color: Color(0xffffcea2),),
          ),
          validator: (value) {

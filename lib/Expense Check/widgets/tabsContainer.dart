...
import 'package:taskulator/Expense%20Check/widgets/tabsGrid.dart';
import 'package:taskulator/Expense%20Check/widgets/tabsInfoHeader.dart';
  ...
  Widget circleBar(bool isActive) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
          color: isActive ? Colors.white : Color(0xff425c5a),
